defmodule FormMetal.Filters.Builders.ExcludeBuilder do
  @moduledoc """
  Build a `exclude` operator for a list filter.
  """
  ...
  defmacro __using__(opts) do
    quote bind_quoted: [opts: opts] do
      ...
      defimpl FormMetal.Filters.Testers.InMemory do
        ...
        def test(filter) do
          nil_guard(filter) do
            not Ecto.Type.include?(unquote(value_ecto_type), filter.value, filter.source)
          end
        end
      end
    end
