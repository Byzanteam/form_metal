defmodule FormMetal.Fields.CheckboxField do
  @moduledoc """
  ...
  ```elixir
  defmodule MyCheckboxField do
    @moduledoc false

    use FormMetal.Fields.CheckboxField
  ...
  defmacro build_field(params, do: block) do
    ...
    [
      ...
      value_type(flavor, quote(do: [String.t(), ...]), quote(do: {:array, :string}))
    ]
  end
